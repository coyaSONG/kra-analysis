...
FEATURE_SOURCE_TIMING_ROWS: tuple[FeatureSourceTimingRow, ...] = (
    ...
    _row(
        ...
        output_fields=(
            "prediction_input.recent_race_count",
            "prediction_input.recent_top3_count",
            "prediction_input.recent_top3_rate",
            "prediction_input.recent_win_count",
            "prediction_input.recent_win_rate",
        ),
        availability_stage="L-1",
        ...
        notes="feature_engineering past_stats 기반 historical lookback",
    ),
    _row(
