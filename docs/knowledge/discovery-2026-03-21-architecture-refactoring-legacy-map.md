...
2026-03-19~21 사이 아키텍처 개선 A~I가 순차적으로 실행되었다 (커밋 `8d55517`~`7e3c3b6`). 이 과정에서 새로운 모듈들이 도입되면서 기존 코드의 일부가 레거시가 되었다. 실행 계획은 `docs/plans/archive/2026-03-19-architecture-rollout-execplan.md`에 기록되어 있다.
