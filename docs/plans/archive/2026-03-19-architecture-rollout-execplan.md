...
- [x] (2026-03-20 01:52 KST) T2 후보 H append-only usage accounting 완료. `usage_events` 모델과 `005_add_usage_events.sql`, `PolicyAccountingMiddleware`를 추가해 policy-guarded 요청마다 append-only usage event가 기록되도록 했다.
