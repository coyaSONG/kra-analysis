...
export class HorseController {
  ...
  getHorseDetails = async (
    req: Request<{ hrNo: string }, ApiResponse<HorseDetails>, {}, HorseQueryParams>,
  ...
  getHorseHistory = async (
    req: Request<{ hrNo: string }, ApiResponse<HorseRaceHistory[]>, {}, HorseQueryParams>,
   ...
   */
  searchHorses = async (
    req: Request<{}, ApiResponse<HorseDetails[]>, {}, HorseQueryParams>,
    res: Response<ApiResponse<HorseDetails[]>>,
    next: NextFunction
  ): Promise<void> => {
    try {
