...
from dependencies.auth import create_access_token, require_api_key, verify_api_key
...
class TestAuthentication:
    ...
    async def test_require_api_key_valid(self, db_session):
        ...
        # Test the dependency
        result = await require_api_key(api_key="valid-api-key-123456", db=db_session)
    ...
    async def test_require_api_key_invalid(self, db_session):
        ...
        with pytest.raises(HTTPException) as exc_info:
            await require_api_key(api_key="invalid-key-123456", db=db_session)
