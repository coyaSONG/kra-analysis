...
async def test_enrich_race_data_with_stats(monkeypatch, db_session):
    ...
    basic = {
        'race_date': '20240719', 'meet': 1, 'race_number': 7,
        'horses': [
    ...
    r = Race(
        race_id=race_id, date='20240719', race_date='20240719', meet=1, race_number=7, race_no=7,
        basic_data=basic, status=DataStatus.COLLECTED
    )
    db_session.add(r)
