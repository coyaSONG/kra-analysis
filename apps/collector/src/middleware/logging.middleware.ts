    ...
    if (chunk) {
      ...
      if (typeof chunk === 'string' || Buffer.isBuffer(chunk)) {
        ...
        if (responseBody.length < 1000) {
          // Limit response body logging to 1KB
 ...
 */
export const performanceLogger = (req: LoggingRequest, res: Response, next: NextFunction): void => {
 ...
 */
export const healthCheckLogger = (req: LoggingRequest, res: Response, next: NextFunction): void => {
