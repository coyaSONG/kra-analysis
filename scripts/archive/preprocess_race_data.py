...
POST_RACE_FIELDS = [
    ...
    # 구간 기록 (모든 경마장)
    'g1fTime', 'g2fTime', 'g3fTime', 'g4fTime',
    's1fTime', 's2fTime', 's3fTime', 's4fTime',
    'buS1fTime', 'buS1fAccTime', 'buS1fOrd',
    ...
    # 서울 구간 기록
    'seS1fTime', 'seS1fAccTime', 'seS1fOrd',
    ...
    # 제주 구간 기록
    'jeS1fTime', 'jeS1fAccTime', 'jeS1fOrd',
...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 3:
        ...
        output_file = os.path.join(dir_name, 'processed', 'pre-race', f"{base_name}_prerace.json")
