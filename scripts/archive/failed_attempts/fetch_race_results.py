...
def fetch_race_result(meet: str, rc_date: str, rc_no: int) -> Optional[Dict]:
...
def load_result_cache(meet: str, rc_date: str, rc_no: int, cache_dir: Path = Path("data/cache/results")) -> Optional[Dict]:
    """캐시에서 결과 로드"""
